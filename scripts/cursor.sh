...
tar xvf $HOME/bspwm/cursors/Nordzy-cursors-white.tar.gz -C ~/.local/share/icons

sudo tar xvf $HOME/bspwm/cursors/Nordzy-cursors-white.tar.gz -C /usr/share/icons
